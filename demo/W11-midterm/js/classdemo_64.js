const showClassDemo = (week) => {
  ...
  switch (week) {
    ...
    case 'w9-md':
      ...
      break;
      case 'mid-p1-64':
      showDemo.innerHTML = `<iframe src='./midterm_64/p1_64/p1_64.html' 
      width="100%" height="100%" />`;
      break;
      case 'mid-p2-64':
      showDemo.innerHTML = `<iframe src='./midterm_64/p2_64/p2_64.html' 
      width="100%" height="100%" />`;
      break;
      case 'mid-p3-64':
      showDemo.innerHTML = `<iframe src='./midterm_64/p3_64/p3_64.html' 
      width="100%" height="100%" />`;
      break;
  }
};
